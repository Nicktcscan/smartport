...
import VehicleRecords from './pages/customs/VehicleRecords';
import DigitalValidation from './pages/customs/DigitalValidation';
import MovementLogs from './pages/customs/MovementLogs';
...
function App() {
  ...
  // Wrap the app in PersistedStateProvider so persisted state is available everywhere.
  // This provider should be implemented at src/context/PersistedStateContext.jsx
  return (
    <PersistedStateProvider>
      ...
      {!user ? (
        <Routes>
          ...
          />
          {/* Only redirect if not a static asset */}
          <Route
            path="*"
